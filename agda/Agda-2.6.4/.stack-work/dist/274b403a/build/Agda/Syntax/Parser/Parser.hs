...
{-# INLINE happyOut35 #-}
newtype HappyWrap36 = HappyWrap36 ([(Interval, String)])
happyIn36 :: ([(Interval, String)]) -> (HappyAbsSyn )
...
{-# INLINE happyOut37 #-}
newtype HappyWrap38 = HappyWrap38 (DList (Interval, String))
happyIn38 :: (DList (Interval, String)) -> (HappyAbsSyn )
...
{-# INLINE happyOut108 #-}
newtype HappyWrap109 = HappyWrap109 (List1 (Arg Declaration))
happyIn109 :: (List1 (Arg Declaration)) -> (HappyAbsSyn )
happyIn109 x = Happy_GHC_Exts.unsafeCoerce# (HappyWrap109 x)
{-# INLINE happyIn109 #-}
happyOut109 :: (HappyAbsSyn ) -> HappyWrap109
happyOut109 x = Happy_GHC_Exts.unsafeCoerce# x
{-# INLINE happyOut109 #-}
newtype HappyWrap110 = HappyWrap110 (List1 Declaration)
happyIn110 :: (List1 Declaration) -> (HappyAbsSyn )
happyIn110 x = Happy_GHC_Exts.unsafeCoerce# (HappyWrap110 x)
{-# INLINE happyIn110 #-}
happyOut110 :: (HappyAbsSyn ) -> HappyWrap110
happyOut110 x = Happy_GHC_Exts.unsafeCoerce# x
{-# INLINE happyOut110 #-}
newtype HappyWrap111 = HappyWrap111 ([Either RewriteEqn (List1 (Named Name Expr))])
happyIn111 :: ([Either RewriteEqn (List1 (Named Name Expr))]) -> (HappyAbsSyn )
happyIn111 x = Happy_GHC_Exts.unsafeCoerce# (HappyWrap111 x)
{-# INLINE happyIn111 #-}
happyOut111 :: (HappyAbsSyn ) -> HappyWrap111
happyOut111 x = Happy_GHC_Exts.unsafeCoerce# x
{-# INLINE happyOut111 #-}
newtype HappyWrap112 = HappyWrap112 (RHSOrTypeSigs)
happyIn112 :: (RHSOrTypeSigs) -> (HappyAbsSyn )
...
{-# INLINE happyOut117 #-}
newtype HappyWrap118 = HappyWrap118 ((Name, IsInstance))
happyIn118 :: ((Name, IsInstance)) -> (HappyAbsSyn )
...
{-# INLINE happyOut131 #-}
newtype HappyWrap132 = HappyWrap132 ([Arg Name])
happyIn132 :: ([Arg Name]) -> (HappyAbsSyn )
happyIn132 x = Happy_GHC_Exts.unsafeCoerce# (HappyWrap132 x)
{-# INLINE happyIn132 #-}
happyOut132 :: (HappyAbsSyn ) -> HappyWrap132
happyOut132 x = Happy_GHC_Exts.unsafeCoerce# x
{-# INLINE happyOut132 #-}
newtype HappyWrap133 = HappyWrap133 ([RString])
happyIn133 :: ([RString]) -> (HappyAbsSyn )
happyIn133 x = Happy_GHC_Exts.unsafeCoerce# (HappyWrap133 x)
{-# INLINE happyIn133 #-}
happyOut133 :: (HappyAbsSyn ) -> HappyWrap133
happyOut133 x = Happy_GHC_Exts.unsafeCoerce# x
{-# INLINE happyOut133 #-}
newtype HappyWrap134 = HappyWrap134 (List1 RString)
happyIn134 :: (List1 RString) -> (HappyAbsSyn )
happyIn134 x = Happy_GHC_Exts.unsafeCoerce# (HappyWrap134 x)
{-# INLINE happyIn134 #-}
happyOut134 :: (HappyAbsSyn ) -> HappyWrap134
happyOut134 x = Happy_GHC_Exts.unsafeCoerce# x
{-# INLINE happyOut134 #-}
newtype HappyWrap135 = HappyWrap135 (DList (NamedArg HoleName))
happyIn135 :: (DList (NamedArg HoleName)) -> (HappyAbsSyn )
...
{-# INLINE happyOut140 #-}
newtype HappyWrap141 = HappyWrap141 (Maybe Range)
happyIn141 :: (Maybe Range) -> (HappyAbsSyn )
happyIn141 x = Happy_GHC_Exts.unsafeCoerce# (HappyWrap141 x)
{-# INLINE happyIn141 #-}
happyOut141 :: (HappyAbsSyn ) -> HappyWrap141
happyOut141 x = Happy_GHC_Exts.unsafeCoerce# x
{-# INLINE happyOut141 #-}
newtype HappyWrap142 = HappyWrap142 (List1 Declaration)
happyIn142 :: (List1 Declaration) -> (HappyAbsSyn )
happyIn142 x = Happy_GHC_Exts.unsafeCoerce# (HappyWrap142 x)
{-# INLINE happyIn142 #-}
happyOut142 :: (HappyAbsSyn ) -> HappyWrap142
happyOut142 x = Happy_GHC_Exts.unsafeCoerce# x
{-# INLINE happyOut142 #-}
newtype HappyWrap143 = HappyWrap143 ([Expr])
happyIn143 :: ([Expr]) -> (HappyAbsSyn )
happyIn143 x = Happy_GHC_Exts.unsafeCoerce# (HappyWrap143 x)
{-# INLINE happyIn143 #-}
happyOut143 :: (HappyAbsSyn ) -> HappyWrap143
happyOut143 x = Happy_GHC_Exts.unsafeCoerce# x
{-# INLINE happyOut143 #-}
newtype HappyWrap144 = HappyWrap144 (Telescope -> Parser ModuleApplication)
happyIn144 :: (Telescope -> Parser ModuleApplication) -> (HappyAbsSyn )
...
{-# INLINE happyOut146 #-}
newtype HappyWrap147 = HappyWrap147 (Name)
happyIn147 :: (Name) -> (HappyAbsSyn )
...
{-# INLINE happyOut174 #-}
newtype HappyWrap175 = HappyWrap175 ([(Range, Occurrence)])
happyIn175 :: ([(Range, Occurrence)]) -> (HappyAbsSyn )
...
{-# INLINE happyOut176 #-}
newtype HappyWrap177 = HappyWrap177 (List1 (Arg TypeSignature))
happyIn177 :: (List1 (Arg TypeSignature)) -> (HappyAbsSyn )
...
{-# INLINE happyOut178 #-}
newtype HappyWrap179 = HappyWrap179 ([Arg TypeSignature])
happyIn179 :: ([Arg TypeSignature]) -> (HappyAbsSyn )
...
{-# INLINE happyOut180 #-}
newtype HappyWrap181 = HappyWrap181 ((RecordDirectives, [Declaration]))
happyIn181 :: ((RecordDirectives, [Declaration])) -> (HappyAbsSyn )
happyIn181 x = Happy_GHC_Exts.unsafeCoerce# (HappyWrap181 x)
{-# INLINE happyIn181 #-}
happyOut181 :: (HappyAbsSyn ) -> HappyWrap181
happyOut181 x = Happy_GHC_Exts.unsafeCoerce# x
{-# INLINE happyOut181 #-}
newtype HappyWrap182 = HappyWrap182 ([RecordDirective])
happyIn182 :: ([RecordDirective]) -> (HappyAbsSyn )
...
{-# INLINE happyOut183 #-}
newtype HappyWrap184 = HappyWrap184 (Ranged HasEta0)
happyIn184 :: (Ranged HasEta0) -> (HappyAbsSyn )
...
{-# INLINE happyOut184 #-}
newtype HappyWrap185 = HappyWrap185 (Range)
happyIn185 :: (Range) -> (HappyAbsSyn )
...
{-# INLINE happyOut185 #-}
newtype HappyWrap186 = HappyWrap186 (Ranged Induction)
happyIn186 :: (Ranged Induction) -> (HappyAbsSyn )
...
{-# INLINE happyOut186 #-}
newtype HappyWrap187 = HappyWrap187 (Declaration)
happyIn187 :: (Declaration) -> (HappyAbsSyn )
...
{-# INLINE happyOut188 #-}
newtype HappyWrap189 = HappyWrap189 ([QName])
...
{-# INLINE happyOut191 #-}
newtype HappyWrap192 = HappyWrap192 (List1 Declaration)
happyIn192 :: (List1 Declaration) -> (HappyAbsSyn )
...
{-# INLINE happyOut192 #-}
newtype HappyWrap193 = HappyWrap193 ([Declaration])
happyIn193 :: ([Declaration]) -> (HappyAbsSyn )
...
happyExpList = HappyA# ""#

{-# NOINLINE happyExpListPerState #-}
happyExpListPerState st =
    token_strs_expected
  where token_strs = ["error","%dummy","%start_tokensParser","%start_exprParser","%start_exprWhereParser","%start_moduleParser","%start_moduleNameParser","%start_funclauseParser","%start_holeContentParser","Tokens","TokensR","Token","File","maybe_vclose","close","semi","beginImpDir","Float","Id","SpaceIds","DoubleCloseBrace","MaybeDottedId","MaybeDottedIds","ArgIds","ModalArgIds","Attribute","Attributes","Attributes1","QId","ModuleName","BId","SpaceBIds","CommaBIds","CommaBIdAndAbsurds","BIdsWithHiding","PragmaStrings","Strings","ForeignCode","PragmaName","PragmaQName","PragmaQNames","Expr","Expr1","WithExprs","UnnamedWithExprs","Application","Expr2","LetBody","ExtendedOrAbsurdLam","Application3","Application3PossiblyEmpty","Expr3Curly","Expr3NoCurly","Expr4","ExprOrAttr","Expr3","RecordAssignments","RecordAssignments1","RecordAssignment","ModuleAssignment","FieldAssignments","FieldAssignments1","FieldAssignment","TeleArrow","Telescope1","TypedBindings","TypedBinding","TBind","ModalTBind","TBindWithHiding","ModalTBindWithHiding","LamBindings","AbsurdLamBindings","LamBinds","LamBindsAbsurd","NonAbsurdLamClause","AbsurdLamClause","LamClause","LamClauses","LamWhereClauses","ForallBindings","TypedUntypedBindings1","TypedUntypedBindings","DomainFreeBindings","DomainFreeBinding","MaybeAsPattern","DomainFreeBindingAbsurd","DoStmts","DoStmt","DoWhere","ImportDirective","ImportDirective1","Using","Hiding","RenamingDir","Renamings","Renaming","RenamingTarget","ImportName_","ImportName","CommaImportNames","CommaImportNames1","LHS","WithClause","HoleContent","WhereClause","ExprWhere","Declaration","ArgTypeSigs","FunClause","WHS","RHS","Data","DataSig","Record","RecordSig","Constructor","RecordConstructorName","Infix","Fields","Generalize","Mutual","Abstract","Private","Instance","Macro","Postulate","Primitive","UnquoteDecl","Syntax","PatternSyn","PatternSynArgs","SimpleIds","SimpleIdsOrWildcards","HoleNames","HoleName","SimpleTopHole","SimpleHole","SimpleId","SimpleIdOrWildcard","MaybeOpen","Open","OpenArgs","ModuleApplication","ModuleMacro","Module","Underscore","TopLevel","Pragma","DeclarationPragma","OptionsPragma","BuiltinPragma","RewritePragma","ForeignPragma","CompilePragma","StaticPragma","InlinePragma","NoInlinePragma","NotProjectionLikePragma","InjectivePragma","DisplayPragma","EtaPragma","NoTerminationCheckPragma","NonTerminatingPragma","TerminatingPragma","NonCoveringPragma","MeasurePragma","CatchallPragma","ImpossiblePragma","NoPositivityCheckPragma","NoUniverseCheckPragma","PolarityPragma","WarningOnUsagePragma","WarningOnImportPragma","Polarities","Polarity","ArgTypeSignatures","ArgTypeSignatures1","ArgTypeSignaturesOrEmpty","ArgTypeSignatures0","RecordDeclarations","RecordDirectives","RecordDirective","RecordEta","RecordPatternMatching","RecordInduction","Opaque","Unfolding","UnfoldingNames","Declarations","Declarations0","Declarations1","TopDeclarations","'abstract'","'codata'","'coinductive'","'constructor'","'data'","'eta-equality'","'field'","'forall'","'variable'","'hiding'","'import'","'in'","'inductive'","'infix'","'infixl'","'infixr'","'instance'","'overlap'","'let'","'macro'","'module'","'interleaved'","'mutual'","'no-eta-equality'","'open'","'pattern'","'postulate'","'primitive'","'private'","'public'","'quote'","'quoteTerm'","'record'","'renaming'","'rewrite'","'syntax'","'tactic'","'to'","'unquote'","'unquoteDecl'","'unquoteDef'","'using'","'where'","'do'","'with'","'opaque'","'unfolding'","'BUILTIN'","'CATCHALL'","'DISPLAY'","'ETA'","'FOREIGN'","'COMPILE'","'IMPOSSIBLE'","'INJECTIVE'","'INLINE'","'NOINLINE'","'MEASURE'","'NO_TERMINATION_CHECK'","'NO_POSITIVITY_CHECK'","'NO_UNIVERSE_CHECK'","'NON_TERMINATING'","'NON_COVERING'","'NOT_PROJECTION_LIKE'","'OPTIONS'","'POLARITY'","'WARNING_ON_USAGE'","'WARNING_ON_IMPORT'","'REWRITE'","'STATIC'","'TERMINATING'","tex","comment","'...'","'..'","'.'","';'","':'","'='","'_'","'?'","'->'","'\\\\'","'@'","'|'","'('","')'","'(|'","'|)'","'(|)'","'{{'","'}}'","'{'","'}'","vopen","vclose","vsemi","'{-#'","'#-}'","id","q_id","string","literal","%eof"]
        bit_start = st Prelude.* 297
        bit_end = (st Prelude.+ 1) Prelude.* 297
        read_bit = readArrayBit happyExpList
        bits = Prelude.map read_bit [bit_start..bit_end Prelude.- 1]
        bits_indexed = Prelude.zip bits [0..296]
        token_strs_expected = Prelude.concatMap f bits_indexed
        f (Prelude.False, _) = []
        f (Prelude.True, nr) = [token_strs Prelude.!! nr]

happyActOffsets :: HappyAddr
happyActOffsets = HappyA# ""#

happyGotoOffsets :: HappyAddr
happyGotoOffsets = HappyA# ""#

happyAdjustOffset :: Happy_GHC_Exts.Int# -> Happy_GHC_Exts.Int#
happyAdjustOffset off = off

happyDefActions :: HappyAddr
happyDefActions = HappyA# ""#

happyCheck :: HappyAddr
happyCheck = HappyA# ""#

happyTable :: HappyAddr
happyTable = HappyA# ""#
...
happy_n_nonterms = 184 :: Prelude.Int
...
happyReduction_400 (happy_x_8 `HappyStk`
	...
	case happyOut191 happy_x_8 of { (HappyWrap191 happy_var_8) -> 
...
happyReduction_404 (happy_x_7 `HappyStk`
	...
	case happyOut42 happy_x_5 of { (HappyWrap42 happy_var_5) -> 
	case happyOutTok happy_x_6 of { (TokKeyword KwWhere happy_var_6) -> 
	case happyOut181 happy_x_7 of { (HappyWrap181 happy_var_7) -> 
...
happyReduction_405 (happy_x_8 `HappyStk`
	...
	case happyOut42 happy_x_6 of { (HappyWrap42 happy_var_6) -> 
	case happyOutTok happy_x_7 of { (TokKeyword KwWhere happy_var_7) -> 
	case happyOut181 happy_x_8 of { (HappyWrap181 happy_var_8) -> 
	( onlyErased (List1.toList happy_var_2) >>= \e ->
...
happyReduction_406 (happy_x_5 `HappyStk`
	...
	case happyOut83 happy_x_3 of { (HappyWrap83 happy_var_3) -> 
	case happyOutTok happy_x_4 of { (TokKeyword KwWhere happy_var_4) -> 
	case happyOut181 happy_x_5 of { (HappyWrap181 happy_var_5) -> 
...
happyReduction_409 (happy_x_4 `HappyStk`
	...
	happyRest)
	 = case happyOutTok happy_x_1 of { (TokKeyword KwData happy_var_1) -> 
	case happyOut191 happy_x_4 of { (HappyWrap191 happy_var_4) -> 
	happyIn117
...
happyReduction_460 (happy_x_7 `HappyStk`
	...
	case happyOut30 happy_x_3 of { (HappyWrap30 happy_var_3) -> 
	case happyOut83 happy_x_4 of { (HappyWrap83 happy_var_4) -> 
	case happyOut144 happy_x_6 of { (HappyWrap144 happy_var_6) -> 
...
happyReduction_513 (happy_x_5 `HappyStk`
	...
	case happyOut39 happy_x_3 of { (HappyWrap39 happy_var_3) -> 
	case happyOut175 happy_x_4 of { (HappyWrap175 happy_var_4) -> 
	case happyOutTok happy_x_5 of { (TokSymbol SymClosePragma happy_var_5) -> 
	happyIn172
...
happyReduction_526 (happy_x_3 `HappyStk`
	...
	happy_x_1 `HappyStk`
	happyRest) tk
	 = happyThen ((case happyOut182 happy_x_2 of { (HappyWrap182 happy_var_2) -> 
...
happyNewToken action sts stk
	...
	TokKeyword KwOpaque happy_dollar_dollar -> cont 46#;
	TokKeyword KwUnfolding happy_dollar_dollar -> cont 47#;
	TokKeyword KwBUILTIN happy_dollar_dollar -> cont 48#;
	TokKeyword KwCATCHALL happy_dollar_dollar -> cont 49#;
	TokKeyword KwDISPLAY happy_dollar_dollar -> cont 50#;
	TokKeyword KwETA happy_dollar_dollar -> cont 51#;
	TokKeyword KwFOREIGN happy_dollar_dollar -> cont 52#;
	TokKeyword KwCOMPILE happy_dollar_dollar -> cont 53#;
	TokKeyword KwIMPOSSIBLE happy_dollar_dollar -> cont 54#;
	TokKeyword KwINJECTIVE happy_dollar_dollar -> cont 55#;
	TokKeyword KwINLINE happy_dollar_dollar -> cont 56#;
	TokKeyword KwNOINLINE happy_dollar_dollar -> cont 57#;
	TokKeyword KwMEASURE happy_dollar_dollar -> cont 58#;
	TokKeyword KwNO_TERMINATION_CHECK happy_dollar_dollar -> cont 59#;
	TokKeyword KwNO_POSITIVITY_CHECK happy_dollar_dollar -> cont 60#;
	TokKeyword KwNO_UNIVERSE_CHECK happy_dollar_dollar -> cont 61#;
	TokKeyword KwNON_TERMINATING happy_dollar_dollar -> cont 62#;
	TokKeyword KwNON_COVERING happy_dollar_dollar -> cont 63#;
	TokKeyword KwNOT_PROJECTION_LIKE happy_dollar_dollar -> cont 64#;
	TokKeyword KwOPTIONS happy_dollar_dollar -> cont 65#;
	TokKeyword KwPOLARITY happy_dollar_dollar -> cont 66#;
	TokKeyword KwWARNING_ON_USAGE happy_dollar_dollar -> cont 67#;
	TokKeyword KwWARNING_ON_IMPORT happy_dollar_dollar -> cont 68#;
...
funclauseParser = happySomeParser where
 happySomeParser = happyThen (happyParse 5#) (\x -> happyReturn (let {(HappyWrap110 x') = happyOut110 x} in x'))
